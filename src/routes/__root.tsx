...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "FA Accounting Services FZ-LLC" },
      ...
      { name: "twitter:title", content: "FA Accounting Services — Trusted Accounting & Tax Partner in UAE" },
      { name: "twitter:description", content: "Professional financial solutions for businesses and startups in the UAE." },
    ],
    links: [
      {
        rel: "stylesheet",
